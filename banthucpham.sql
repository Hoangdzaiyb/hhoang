...
(1, 'hoang', '123', 'nhhoang@gmail.com', 'hoang admin', 'Yên Bái', '0363211628', '2004-06-16');
...
(1001, 1, 1, 'Cải Tím Tam Nông', '- Thực phẩm tốt cho sức khỏe</br>- Có thể chế biến thành nhiều món ăn</br>- Hương vị thơm ngon, kích thích vị giác', 50000, 10, 'bapcaitim.png', 'co'),
(1002, 1, 1, 'Đậu Leo Tam Nông', '- Dùng chế biến món ăn- Chứa nhiều chất dinh dưỡng cần thiết- An toàn chất lượng', 35000, 10, 'daudua.png', 'co'),
(1003, 1, 2, 'Cải Bẹ Tam Nông ', '- Được trồng trong môi trường sạch an toàn với người tiêu dùng- Dùng để nấu canh, xào hoặc có thể dùng ăn với lẩu- Bổ sung nhiều chất dinh dưỡng cần thiết cho cơ thể', 35500, 10, 'caibe.png', 'co'),
(2001, 1, 1, 'Khổ qua Tam Nông', '- Thực phẩm tốt cho sức khỏe\r\n- Có thể chế biến được thành nhiều món ăn\r\n- Sản phẩm được người tiêu dùng ưa chuộng\r\n \r\n\r\n', 18000, 10, 'khoqua.png', 'co'),
(2002, 2, 2, 'Cà chua Tam Nông', '- Cung cấp đầy đủ vitamin và dưỡng chất cho cơ thể\r\n- Đạt tiêu chuẩn Vietgap\r\n- Liên hệ trực tiếp để được giá sỉ tốt nhất', 18000, 10, 'cachua.png', 'co'),
(2003, 2, 1, 'Bầu Tam Nông', '- Món ăn lý tưởng dành cho người muốn giảm cân- Chế biến được nhiều món ăn ngon miệng- Sản phẩm không sử dụng thuốc trừ sâu, an toàn cho sức khỏe', 20000, 10, 'bauphuocan.png', 'ko'),
...
(3015, 3, 1, 'Thịt Dê', 'ngon',300000,10,'image/product/tac-dung-cua-thit-de.jpg','ko');
